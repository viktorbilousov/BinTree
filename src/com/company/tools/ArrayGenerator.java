...
public class ArrayGenerator {
    ...
    public static Integer[] nextArrayInteger(int size, int max, int min) {
        Integer[] integers = new Integer[size];
        int[] nums = nextArrayInt(size, max, min) ;
    ...
    public static Integer[] nextArrayInteger(int size, int max){
        Integer[] integers = new Integer[size];
        int[] nums = nextArrayInt(size, max) ;
        for (int i = 0; i < nums.length; i++) {
            integers[i] = nums[i];
        }
        return integers;
